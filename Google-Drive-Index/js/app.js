...
function init() {
	...
	var html = `
	<head>
	<title>ajarouihCDN</title>
	<link rel="icon" href="https://www.ajarouih.me/img/favicon.png">
	</head>
<header >
   <div id="nav">
   </div>
...
function nav(path) {
  ...
  <a class="navbar-brand" href="/${cur}:/">${UI.logo_image ? '<img border="0" alt="'+navbar-brand+'" src="'+UI.logo_link_name+'" height="'+UI.height+'" width="'+UI.logo_width+'">' : UI.logo_link_name}</a>
